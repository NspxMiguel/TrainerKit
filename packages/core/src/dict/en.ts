...
const EN = {
  ...
  "especies.loadError": "Couldn't load the dataset. {message}",
  "especies.search": "Search species",
  "especies.searchPlaceholder": "Search by name",
  "especies.count.one": "1 species",
  "especies.count.many": "{count} species",
  "especies.noResults": "Nothing matches “{query}”.",
  "especies.showMore": "Show more ({count} left)",
  "especies.qual": "Which species?",
  ...
  "usos.none": "Nothing competitive. Collection only.",
  "usos.raide": "Raids",
  ...
  "trade.no.shadow": "Shadow species can't be traded. Purify it first — and that removes the 20% attack bonus.",
  "trade.no.traded": "A lucky species came from a trade, and a traded species can't be traded again.",
  "trade.friend": "Friend",
  ...
  "faxina.intro": "TrainerKit can't touch the game. Transfer them in o jogo first, then take them off this list.",
  "faxina.open": "Cleanup",
  ...
  "collection.empty.title": "No species saved",
  ...
  "collection.noMatch.body": "No species in your collection matches “{q}”.",
  ...
  "privacy.local.rights": "You can export everything to a JSON file from Species › Mine, and erase everything in Settings › Erase all app data. We hold no copy — when you erase it, it's gone.",
  ...
  "privacy.third.intro": "Only when you use the AI, the voice, or leave the species images on. In those cases what is described below goes to the services listed. With all three off, nothing leaves.",
  "privacy.third.groq": "• Groq (USA) — receives your question and the data the app computed about the species or your collection. Only what's in the question: no name, email or identifier of yours.",
  "privacy.third.photo": "• Identifying a species by photo sends THE IMAGE you pick to Groq. It's the only case where a file of yours leaves the device. We don't store the image.",
  "privacy.third.ms": "• Microsoft (USA) — receives the text the lens will read aloud, when you use the neural voice.",
  "privacy.third.eleven": "• ElevenLabs (USA) — receives the text to be read, when you pick an ElevenLabs voice.",
  "privacy.third.img": "• GitHub (USA) — species images are fetched from there as you browse, if the image source is on in Settings › Images. Only the image address and your IP go out. Downloading the images to the device (same screen) or choosing \"No images\" stops it.",
  ...
  // ------------------------------------------------------------------ onboarding
  "onb.aria": "Welcome",
  "onb.tagline": "It tells you what to do with each species you catch.",
  ...
  "onb.level.mid": "MID",
  "onb.level.high": "HIGH",
  "onb.level.max": "OR MORE",
  "onb.level.what": "At level {nivel} you can power a species up to level {teto}. The app will not tell you to invest in what you cannot reach yet.",
  "onb.start": "Start",
  ...
  "items.evolution": "EVOLUTION ITEMS",
  "items.other": "THE REST",
  "items.unnamed": "Evolution item",
  "items.evolves": "{de} → {para}",
  "items.rareCandy": "Turns into candy for any species you pick. Spend it on what you rarely find.",
  "items.rareCandyXL": "Same thing, but XL candy — the kind you need to power a species past level 40.",
  "items.statSingle": "Raises ONE of the three IVs. It is what brings an almost-perfect one closer to 100%.",
  "items.statTriple": "Raises all THREE IVs at once.",
  "items.fastTM": "Rerolls the fast move. Random: it can come back worse.",
  "items.chargedTM": "Rerolls the charged move. Random too.",
  "items.eliteTM": "You choose the move, including ones from past events. One of the rarest items in the game.",
  "support.title": "Support",
  "support.body": "TrainerKit is free, has no ads, and collects nothing about you. It stays that way. If it has been useful, a donation helps keep it going.",
  "support.note": "Voluntary. Nothing in the app changes if you send one.",
  "support.address": "Bitcoin address",
  ...
  "sprites.homeDetail": "Uniform 3D models. More consistent across species.",
  ...
  "assistant.profile.weak": "Weak at both. Collection only.",
  ...
  "sprites.manifestHelp": "The manifest is a JSON with {nameField} and {templateField} — for example {example}. In a .zip, the file name is what matches: {byDex} by Species number, {byName} by name. Folders are ignored.",
  "home.seeAll": "See all",
  ...
  "raid.openBrowse": "How to take it down",
  "raid.bossCp": "{cp} CP",
  "raid.bossHp": "{hp} HP",
  "raid.tier": "Tier {n}",
  "raid.tierMega": "Mega",
  ...
  "raid.recommended": "Best against it",
  "raid.recommendedNote": "Anyone can use these. Level 40, 15/15/15 — the realistic best case, not your collection.",
  "raid.dps": "DPS",
  ...
  "raid.emptyBody": "Save your species and this becomes an answer about your own collection.",
  ...
  "ai.err.offTopic": "I only know o jogo. Ask about a species, a move, a raid, or your collection.",
  ...
  "ai.what": "Ask about your species in plain words. It reads the verdicts the app already calculated and answers from them — it never invents a number.",
  "settings.usage": "How you use it",
  "raid.emptyBrowse": "This answer comes from your collection. Switch to collection mode in Settings to save your species.",
  "type.normal": "Normal",
  ...
  "gym.emptyCollection": "Save a few species first and this becomes a list of yours.",
  ...
  "voice.enabledDetail": "The lens reads the entry when it identifies something.",
  "voice.pick": "Voice",
  ...
  "dex.browse": "Browse the catalog",
  "dex.open": "Lens mode",
  "dex.openDetail": "Point, ask, and hear the entry",
  "dex.pick": "Which species?",
  ...
  "dex.openFull": "Open the full entry",
  ...
  "team.bossNotFound": "No species found for “{query}”.",
  ...
  "tip.lucky": "Lucky species cost half the dust to power up — and always come with at least 12 in every IV.",
  ...
  "source.title": "Your own sources",
  "source.body": "The app ships with no artwork and one built-in database. Point it somewhere else and it follows you, not me.",
  "source.img.custom": "Your own manifest",
  "source.img.customDetail": "A JSON with an address template, or a species-by-species map.",
  "source.img.hint": "Address of the manifest",
  "source.data.title": "Game database",
  "source.data.body": "The bundled one comes from the public GAME_MASTER. A fork that updates faster works too.",
  "source.data.builtin": "The bundled one",
  "source.data.hint": "Address of the .json",
  "source.check": "Check and use",
  "source.checking": "Checking…",
  "source.clear": "Back to the bundled one",
  "source.ok": "In use: {name}",
  "source.err.notObject": "That is not a JSON object",
  "source.err.noName": "The manifest has no name",
  "source.err.noImages": "No template and no images — one of the two is needed",
  "source.err.badImages": "\"images\" is not a map",
  "source.err.badUrl": "Invalid address",
