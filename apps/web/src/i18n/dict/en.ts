...
const EN = {
  ...
  "usos.none": "Nothing competitive. Species only.",
  "usos.raide": "Raids",
  ...
  "privacy.third.ms": "• Microsoft (USA) — receives the text the Species will read aloud, when you use the neural voice.",
  ...
  "assistant.profile.weak": "Weak at both. Species only.",
  ...
  "voice.enabledDetail": "The Species reads the entry when it identifies something.",
  "voice.pick": "Voice",
  ...
  "dex.browse": "Browse the Species",
  "dex.open": "Species mode",
