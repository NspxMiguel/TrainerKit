...
const EN = {
  ...
  "help.donateTitle": "DONATE",
  "help.donateBody": "A donation pays for the shared AI key — the one that serves people who don't want to set anything up. It unlocks nothing: there is no paid feature, no higher limit for donors, and no ad to remove. The app is exactly the same for someone who donates and someone who never will.",
  "help.donateWhy": "The app isn't for sale and won't be. The analysis is built on game data, which isn't mine to sell — a donation buys nothing, and that's exactly why it fits here while a paid version wouldn't.",
  "help.donateBtn": "Donate on GitHub Sponsors",
  "help.donateFree": "Adding your own key helps just as much and costs nothing. It's right below.",
  ...
  "privacy.donate.title": "DONATIONS",
  "privacy.donate.body": "Donating is optional and happens outside the app: the button opens GitHub Sponsors, and the payment is made there. TrainerKit never receives, sees or stores any payment data, and doesn't know who donated — nor would it have any use for that, since no feature depends on having donated.",
