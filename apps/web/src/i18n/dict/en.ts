...
const EN = {
  ...
  "privacy.local.rights": "You can export everything to a JSON file from the Collection tab, and erase everything in Settings › Erase all app data. We hold no copy — when you erase it, it's gone.",
